...
export default function ResumeBuilder({ initialContent }) {
  ...
  {/* Warning Banner */}
  {activeTab === "preview" && resumeMode !== "preview" && (
    <div className="flex p-4 gap-3 items-start border border-yellow-400 bg-yellow-50 text-yellow-700 rounded-xl mb-5 shadow-sm">
      <AlertTriangle className="h-5 w-5 mt-0.5 shrink-0" />
      <span className="text-sm">
        ⚠️ Manual edits here will be <b>overwritten</b> if you update the form data.
      </span>
    </div>
  )}
  ...
  <div className="rounded-2xl border bg-white shadow-md overflow-hidden">
    <MDEditor
      ...
      textareaProps={{
        placeholder: "✍️ Write or refine your resume in Markdown here...",
      }}
    />
  </div>

  {/* Hidden PDF Section for Download */}
  <div className="hidden">
    <div id="resume-pdf">
      <MDEditor.Markdown
        source={previewContent}
